...
| `payload.py` | The one JSON shape the canvas consumes: plan meta, every node with raw and effective fields plus body, current findings, the view layout, and the kind definiti… |
