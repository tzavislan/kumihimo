...
| `events.py` | Tails `.kumihimo/events.jsonl` for the live push (K31): one EventTail per running server, starting at end-of-file so a freshly opened editor never replays hist… |
