...
### 1. v2 endpoint surface · effort S
*After:* nothing — ready as soon as you reach it.
*Also part of:* Ship guarded API
...
### 2. Question: Per-org or per-key quotas?
...
### 3. Decision: Rate-limit algorithm
...
### 4. Rate-limit middleware · effort M
*After:* 1. v2 endpoint surface; 3. Rate-limit algorithm
*Also part of:* Ship guarded API
...
### 5. Limit headers and 429 body · effort S
*After:* 4. Rate-limit middleware
*Also part of:* Ship guarded API
